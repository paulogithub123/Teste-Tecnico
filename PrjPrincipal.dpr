...
uses
  ...
  uVendasItensProdutoControl in 'Control\uVendasItensProdutoControl.pas',
  uVendasItensProdutoModel in 'Model\uVendasItensProdutoModel.pas',
  uVendasItensProdutoDAO in 'Dao\uVendasItensProdutoDAO.pas';
